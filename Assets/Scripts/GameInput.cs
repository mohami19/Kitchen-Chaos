...
public class GameInput : MonoBehaviour
{
    ...
    public const string PLAYER_PREFS_BINDING = "inputBinding";
    ...
    private void Awake()
    {
        if (Instance != null)
        {
            Debug.LogError("More than one GameInput in the scene!");
            Destroy(gameObject);
            return;
        }
        Instance = this;
    ...
    private void InteracttAlternate_performed(InputAction.CallbackContext obj)
    {
